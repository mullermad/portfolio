...
<template>
    <div class="bg-gray-800 min-h-screen w-full pt-24 pb-40 flex justify-center items-center">
        <div class="flex flex-col px -5  md:px-64 items-center">
            ...
            <div class="bg-white flex rounded-lg shadow-lg p-6  w-full  mt-8">
                <div>
                    <div class="text-center mb-6">
                        <h1 class="text-2xl font-bold text-gray-800">Contact Me</h1>
                    </div>
                    <div class="flex flex-col gap-4 md:flex-row md:justify-between ">
                        <div class="flex items-center gap-2 text-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="text-blue-500"
                                viewBox="0 0 24 24">
                                <path fill="currentColor" fill-opacity="0" stroke="currentColor" stroke-dasharray="64"
                                    ...
                                    <animate fill="freeze" attributeName="fill-opacity" begin="0.7s" dur="0.5s"
                                        values="0;1" />
                                    <animate fill="freeze" attributeName="stroke-dashoffset" dur="0.6s" values="64;0" />
                                </path>
                            </svg>
                            <a href="tel:+251943438385"
                                class="text-blue-500 font-bold hover:underline">+251943438385</a>
                        </div>
                        <div class="flex items-center gap-2 text-lg">
                            <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" class="text-blue-500"
                                viewBox="0 0 24 24">
                            ...
                            <a href="mailto:mulukendemis44@gmail.com"
                                class="text-blue-500 mr-2 font-bold hover:underline">mulukendemis44@gmail.com</a>
                        </div>
                    </div>
                </div>
            </div>
